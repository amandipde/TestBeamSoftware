...
namespace ROOT {
   static void *new_TelescopeEvent(void *p = 0);
   static void *newArray_TelescopeEvent(Long_t size, void *p);
   static void delete_TelescopeEvent(void *p);
   static void deleteArray_TelescopeEvent(void *p);
   static void destruct_TelescopeEvent(void *p);

   // Function generating the singleton type initializer
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::TelescopeEvent*)
   {
      ::TelescopeEvent *ptr = 0;
      static ::TVirtualIsAProxy* isa_proxy = new ::TInstrumentedIsAProxy< ::TelescopeEvent >(0);
      static ::ROOT::TGenericClassInfo 
         instance("TelescopeEvent", ::TelescopeEvent::Class_Version(), "TelescopeEvent.h", 32,
                  typeid(::TelescopeEvent), ::ROOT::Internal::DefineBehavior(ptr, ptr),
                  &::TelescopeEvent::Dictionary, isa_proxy, 4,
                  sizeof(::TelescopeEvent) );
      instance.SetNew(&new_TelescopeEvent);
      instance.SetNewArray(&newArray_TelescopeEvent);
      instance.SetDelete(&delete_TelescopeEvent);
      instance.SetDeleteArray(&deleteArray_TelescopeEvent);
      instance.SetDestructor(&destruct_TelescopeEvent);
      return &instance;
   }
   TGenericClassInfo *GenerateInitInstance(const ::TelescopeEvent*)
   {
      return GenerateInitInstanceLocal((::TelescopeEvent*)0);
   }
   // Static variable to force the class initialization
   static ::ROOT::TGenericClassInfo *_R__UNIQUE_DICT_(Init) = GenerateInitInstanceLocal((const ::TelescopeEvent*)0x0); R__UseDummy(_R__UNIQUE_DICT_(Init));
} // end of namespace ROOT
...
{
   return ::ROOT::GenerateInitInstanceLocal((const ::TelescopeEvent*)0x0)->GetImplFileName();
}

//______________________________________________________________________________
int TelescopeEvent::ImplFileLine()
{
   return ::ROOT::GenerateInitInstanceLocal((const ::TelescopeEvent*)0x0)->GetImplFileLine();
}

//______________________________________________________________________________
TClass *TelescopeEvent::Dictionary()
{
   fgIsA = ::ROOT::GenerateInitInstanceLocal((const ::TelescopeEvent*)0x0)->GetClass();
   return fgIsA;
}
...
{
   if (!fgIsA.load()) { R__LOCKGUARD2(gInterpreterMutex); fgIsA = ::ROOT::GenerateInitInstanceLocal((const ::TelescopeEvent*)0x0)->GetClass(); }
   return fgIsA;
}
...
{
   // Stream an object of class TelescopeEvent.

   if (R__b.IsReading()) {
      R__b.ReadClassBuffer(TelescopeEvent::Class(),this);
   } else {
      R__b.WriteClassBuffer(TelescopeEvent::Class(),this);
   }
}

namespace ROOT {
   // Wrappers around operator new
   static void *new_TelescopeEvent(void *p) {
      return  p ? new(p) ::TelescopeEvent : new ::TelescopeEvent;
   }
   static void *newArray_TelescopeEvent(Long_t nElements, void *p) {
      return p ? new(p) ::TelescopeEvent[nElements] : new ::TelescopeEvent[nElements];
   }
   // Wrapper around operator delete
   static void delete_TelescopeEvent(void *p) {
      delete ((::TelescopeEvent*)p);
   }
   static void deleteArray_TelescopeEvent(void *p) {
      delete [] ((::TelescopeEvent*)p);
   }
   static void destruct_TelescopeEvent(void *p) {
      typedef ::TelescopeEvent current_t;
      ((current_t*)p)->~current_t();
   }
} // end of namespace ROOT for class ::TelescopeEvent
...
class __attribute__((annotate("$clingAutoload$TelescopeEvent.h")))  TelescopeEvent;
